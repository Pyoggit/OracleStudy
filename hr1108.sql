...
ALTER TABLE SUBJECT01 ADD CONSTRAINT SUBJECT01_subnum_UK UNIQUE(subnum);
...
ALTER TABLE STUDENT01 ADD CONSTRAINT STUDENT01_stunum_UK UNIQUE(stunum);
...
ALTER TABLE LESSON01 ADD CONSTRAINT LESSON01_lnum_UK UNIQUE(lnum);
