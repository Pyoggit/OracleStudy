...
INSERT INTO EMP01 VALUES(7339,'RRETH','LEEAK',7339,'85/12/17',800,0.0,20);
--EMP01 데이터 보기
SELECT * FROM EMP01;
...
-- 대여반납 테이블 제약조건
ALTER TABLE LEND ADD CONSTRAINT LEND_L_CODE_PK PRIMARY KEY(L_CODE);
ALTER TABLE LEND ADD CONSTRAINT LEND_CODE_FK FOREIGN KEY(CODE) REFERENCES CUSTOMER01(CODE);
ALTER TABLE LEND ADD CONSTRAINT LEND_V_CODE_FK FOREIGN KEY(V_CODE) REFERENCES VIDEO(V_CODE);